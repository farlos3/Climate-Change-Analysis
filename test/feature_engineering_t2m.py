...
def add_advanced_features(df_fe: pd.DataFrame) -> pd.DataFrame:
    ...
    print("1. Temperature Volatility Features")
    ...
    print("2. Weather Pattern Features")
    ...
    print("3. Cross-variable Interactions")
    ...
    print(f"Advanced features added: {len(df_advanced.columns) - len(df_fe.columns)}")
